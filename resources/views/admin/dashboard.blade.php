...
@section('content')
    ...
    $bulanTahunList = $pembayarans->map(
        fn($item) =>
    ...
    $totalPemasukanBulanIni = $pembayarans->filter(
        fn($item) =>
    ...
    $totalTransaksiHariIni = $pembayarans->filter(
        fn($item) =>
    ...
    <div class="d-flex flex-wrap gap-3 mb-4">
        ...
        <div class="card p-3" style="min-width: 200px;">
            <div>
                <h5><strong>Rp {{ number_format($totalPemasukanBulanIni, 0, ',', '.') }}</strong></h5>
        ...
        <div class="card p-3" style="min-width: 200px;">
            <div>
                <h5><strong>Rp {{ number_format($pengeluaranBulanIni, 0, ',', '.') }}</strong></h5>
    ...
    <div class="card mb-4" style="width: 100%; height: 450px;">
        <div class="card-header bg-header-blue" style="background-color: #409dfd; color: white;">
            <strong>Penjualan Perbulan</strong>
        </div>
            <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-4 mt-400">
            ...
            <div class="card" style="background-color: white; flex: none; width: 300px; max-width: 300px; min-width: 150px; height: 400px;">
                <div class="card-header" style="background-color: #409dfd; color: white;">
            ...
            <div class="card" style="flex: 1; color: black; height: 100%;">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #409dfd; color: white;">
